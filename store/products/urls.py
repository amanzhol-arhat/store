...
urlpatterns = [
    ...
    path('category/<int:category_id>', ProductsListView.as_view(), name = 'category'), #../products/category/<id>/
    path('page/<int:page>', ProductsListView.as_view(), name = 'paginator'), #../products/category/<id>/
